        ...
        <div className="w-full flex flex-col gap-6 z-100">
            <div className="w-full dark:border shadow bg-white dark:bg-black border-gray-600 rounded p-4  flex flex-col gap-3 relative">
                <button 
                    ...
                    className="md:hidden absolute group top-1 right-1 p-1 bg-gray-200 dark:bg-dark800 shadow dark:shadow-gray-700 rounded dark:border border-gray-600 flex items-center justify-center">
                    <CloseRoundedIcon className="group-hover:text-sapphire"/>
                </button>
                <h1 className="dark:text-white font-bold">About the Author</h1>
                <div className="w-full rounded flex items-start gap-2 bg-gray-200 dark:bg-dark800 p-2">
                    ...
                    <div className="flex-1 flex-col gap-2">
                        <div className="w-full">
                            <h1 className="dark:text-white">RedHat_109</h1>
            ...
            <div className="w-full dark:border bg-white dark:bg-black shadow border-gray-600 rounded p-4  flex flex-col gap-3">
                <h1 className="dark:text-white font-bold">Related Posts</h1>

                <div className="w-full flex flex-col gap-2">
                    <Link  href="" className="flex flex-col gap-2 pl-6 p-2 rounded-sm border-b transition-all duration-300 ease-in-out border-gray-600 dark:hover:bg-dark800 hover:bg-gray-200">
                        <div className="w-full">
                            <p className="dark:text-white text-gray-500 font-bold  text-sm">Building Defi Protocols with Uniswap V4</p>
                            <p className="dark:text-white text-gray-500 font-bold  text-sm">Learn about the new hooks architecture</p>
                        </div>
                        <div className="flex items-center gap-2">
                            <span className="dark:bg-dark700 bg-gray-400 text-white dark:text-gray-300 p-1 rounded text-[12px]">DeFi</span>
                            <span className="dark:bg-dark700 bg-gray-400 text-white dark:text-gray-300 p-1 rounded text-[12px]">Uniswap</span>
                        </div>
                    </Link>
                    <Link  href="" className="flex flex-col gap-2 pl-6 p-2 rounded-sm border-b transition-all duration-300 ease-in-out border-gray-600 dark:hover:bg-dark800 hover:bg-gray-200">
                        <div className="w-full">
                            <p className="dark:text-white text-gray-500 font-bold text-sm">Zero-Knowledge Rollups: Complete Guide</p>
                            <p className="dark:text-white text-gray-500 font-bold text-sm">Scalling Ethereum with ZK-Rollups</p>
                        </div>
                        <div className="flex items-center gap-2">
                            <span className="dark:bg-dark700 bg-gray-400 text-white dark:text-gray-300 p-1 rounded text-[12px]">ZK-Rollups</span>
                            <span className="dark:bg-dark700 bg-gray-400 text-white dark:text-gray-300 p-1 rounded text-[12px]">Scalling</span>
                        </div>
                    </Link>
                    <Link  href="" className="flex flex-col gap-2 pl-6 p-2 rounded-sm transition-all duration-300 ease-in-out dark:hover:bg-dark800 hover:bg-gray-200">
                        <div className="w-full">
                            <p className="dark:text-white text-gray-500 font-bold text-sm">Smart Contract Security Audit Checklist</p>
                            <p className="dark:text-white text-gray-500 font-bold text-sm">Common vulnerabilities and how to avoid them</p>
                        </div>
                        <div className="flex items-center gap-2">
                            <span className="dark:bg-dark700 bg-gray-400 text-white dark:text-gray-300 p-1 rounded text-[12px]">Security</span>
                            <span className="dark:bg-dark700 bg-gray-400 text-white dark:text-gray-300 p-1 rounded text-[12px]">Audit</span>
                        </div>
                    </Link>
                </div>
            </div>
