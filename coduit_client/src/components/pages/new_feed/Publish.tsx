            ...
            <div className="w-full flex-col gap-1 p-4 bg-black rounded border border-gray-600 pt-2 ">
                ...
                <div className="w-full flex flex-col gap-3 mt-2">
                    {publishOptions.map(option =>{
                        ...
                        return(
                            <button className="w-full p-2 rounded border border-gray-600 bg-dark800 flex items-center justify-center gap-2 hover:bg-sapphire/10 hover:border-sapphire group transition-all duration-300 ease-in-out">
