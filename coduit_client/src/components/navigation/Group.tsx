...
export default function Groups({ id }: GroupProps) {
  ...
  return (
    <div 
      ref={dropdownRef}
      className={`w-full relative rounded-md pl-1 p-2 transition-all duration-300 ease-in-out hover:bg-gray-400 hover:shadow dark:hover:bg-[#232323] ${isOpen ? "bg-gray-400 dark:bg-[#232323]" : "bg-gray-200 dark:bg-black"}`}
    >
      <button
      ...
      <div
        ...
        role="menu"
        aria-labelledby={`groups-button-${id}`}
      >
        <div className="w-3/4 shadow-xl bg-gray-200 dark:bg-black px-1 rounded">
          ...
          <div className="w-full flex flex-col items-start justify-between gap-1 py-1 border-b border-gray-700">
            <Link 
              href="" 
              className='group hover:bg-gray-400 dark:hover:bg-dark800 rounded pl-1 hover:text-sapphire transition-all duration-300 ease-in-out w-full p-2 px-0 flex items-center justify-start gap-2'
              role="menuitem"
              tabIndex={isOpen ? 0 : -1}
            ...
            <Link 
              href="" 
              className='hover:bg-gray-400 dark:hover:bg-dark800 group rounded pl-1 hover:text-sapphire transition-all duration-300 ease-in-out w-full p-2 px-0 flex items-center justify-start gap-2'
              role="menuitem"
              tabIndex={isOpen ? 0 : -1}
              onClick={() => setOpenDropdownId(null)}
            >
          ...
          <div className="w-full flex flex-col items-start justify-between gap-1 py-1">
            <Link 
              href="" 
              className='group hover:bg-gray-400 dark:hover:bg-dark800 rounded pl-1 w-full p-2 px-0 flex items-center justify-start gap-2'
              role="menuitem"
              tabIndex={isOpen ? 0 : -1}
              onClick={() => setOpenDropdownId(null)}
            >
