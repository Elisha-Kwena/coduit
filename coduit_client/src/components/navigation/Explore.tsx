...
export default function Explore({ id }: { id: string }) {
    ...
    return (
    <div className={`w-full relative rounded pl-1 p-2 transition-all duration-300 ease-in-out dark:hover:bg-[#232323] hover:bg-gray-400 ${isOpen ? "bg-gray-400 dark:bg-[#232323]":"bg-gray-200 dark:bg-black"}`}>
      <button
